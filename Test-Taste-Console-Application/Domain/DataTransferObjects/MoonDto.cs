...
namespace Test_Taste_Console_Application.Domain.DataTransferObjects
{
    ...
    public class MoonDto
    {
        ...
        [JsonProperty("gravity")] public decimal gravity { get; set; }  // it will retrieve gravity of moon
        ...
        [JsonProperty("mass.massValue")] public decimal MassValue { get; set; }
        [JsonProperty("mass.massExponent")] public decimal MassExponent { get; set; }
    }
}
